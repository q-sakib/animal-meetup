...
const animalImageStorage = multer.diskStorage({
  destination: function (req, file, cb) {
    // Create a dedicated folder for animal images
    cb(null, uploadDir);  // Use the 'uploads/animals' folder for uploads
  },
  filename: function (req, file, cb) {
    // Generate unique filenames using the timestamp and original file name
